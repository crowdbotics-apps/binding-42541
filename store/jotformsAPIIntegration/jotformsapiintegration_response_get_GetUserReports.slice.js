...
export const jotformsapiintegration_get_reports_read = createAsyncThunk("jotformsapiintegration_response_get_GetUserReports/jotformsapiintegration_get_reports_read", async payload => {
  const response = await apiService.jotformsapiintegration_get_reports_read(payload);
