...
function api_docs_schema_retrieve(payload) {
  return bindingAPI.get(`/api-docs/schema/`, {
    params: {
      lang: payload.lang
    }
  });
...
function modules_camera_photos_user_list(payload) {
  return bindingAPI.get(`/modules/camera/photos/user/`);
}

function modules_camera_photos_user_retrieve(payload) {
  return bindingAPI.get(`/modules/camera/photos/user/${payload.id}/`);
}

function modules_camera_upload_image_create(payload) {
  return bindingAPI.post(`/modules/camera/upload_image/`);
}

function rest_auth_login_create(payload) {
  return bindingAPI.post(`/rest-auth/login/`, payload.data);
}
...
function rest_auth_password_change_create(payload) {
  return bindingAPI.post(`/rest-auth/password/change/`, payload.data);
}

function rest_auth_password_reset_create(payload) {
  return bindingAPI.post(`/rest-auth/password/reset/`, payload.data);
}

function rest_auth_password_reset_confirm_create(payload) {
  return bindingAPI.post(`/rest-auth/password/reset/confirm/`, payload.data);
}

function rest_auth_registration_create(payload) {
  return bindingAPI.post(`/rest-auth/registration/`, payload.data);
}

function rest_auth_registration_verify_email_create(payload) {
  return bindingAPI.post(`/rest-auth/registration/verify-email/`, payload.data);
}
...
function rest_auth_user_update(payload) {
  return bindingAPI.put(`/rest-auth/user/`, payload.data);
}

function rest_auth_user_partial_update(payload) {
  return bindingAPI.patch(`/rest-auth/user/`, payload.data);
}
