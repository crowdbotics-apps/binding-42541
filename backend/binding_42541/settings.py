"""
Django settings for binding_42541 project.
...
ROOT_URLCONF = 'binding_42541.urls'
...
WSGI_APPLICATION = 'binding_42541.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "binding_42541 API",
    "DESCRIPTION": "API documentation for binding_42541 App",
    "VERSION": "v1",
}
